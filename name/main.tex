...
The combined effect of the SBC--offshore-FC horizontal pair and SBC--slope-FC vertical pair is a conversion of widespread northward Ekman transport into downwelling with little impact on the eastward SBC transport. In contrast, the onshore flows feeding into the FC are largely converted into increasing westward FC transport.
